...
# The file got butchered. Let's look for the remaining parts to stitch it back together.
$startMarker = '<li style="color: var(--white); opacity: 0.8; font-size: 0.875rem;">Ã°Å¸â€œÂ  Colombo Trade City, Colombo 03</li>'
$endMarker = '<a href="#" style="color: var(--dark); display: flex; align-items: center; justify-content: center; width: 40px; height: 40px; border-radius: 50%; background-color: var(--light); transition: 0.3s;" onmouseover="this.style.backgroundColor=''var(--primary)''" onmouseout="this.style.backgroundColor=''var(--light)''">' + "`n" + '            <!-- YouTube SVG -->'
...
if ($startIndex -ge 0 -and $endIndex -ge 0) {
    ...
    $insertion = @"
        <li style="color: var(--white); opacity: 0.8; font-size: 0.875rem;">&#128205; Colombo Trade City, Colombo 03</li>
...
"@
    ...
    [System.IO.File]::WriteAllText("f:\Website\profile.html", $newContent, (New-Object System.Text.UTF8Encoding $false))
